...
elo_df <- read.csv("C:\\Users\\piyus\\Tidy-Tuesday-master\\Tidy-Tuesday-master\\Season 1\\Data\\elo_df.csv")
df <- read.csv("C:\\Users\\piyus\\Tidy-Tuesday-master\\Tidy-Tuesday-master\\Season 1\\Data\\elo.csv")
